      ...
      pageStatus: {
        handler: async function pageStatusHandler () {
          ...
          try {
            ...
            if (role === 'wyry') {
              this.pageData.taskList = ((await this.$request('/PatrolInspection/selectByCriteria', 'POST', {
            ...
            } else if (role === 'wyjl' || role === 'gwh') {
              this.pageData.taskList = ((await this.$request('/PatrolInspection/selectByDeptId', 'POST', {
