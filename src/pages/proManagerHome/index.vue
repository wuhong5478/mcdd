<template>
  <div class="content">
    ...
    <div class="content-comment">
      ...
      <div class="content-comment-main" @click="handleTownAnalyzeClick">
        <div class="content-comment-main-left">
          <div class="content-comment-main-left-title">园区概况评估</div>
          <div class="content-comment-main-left-mark">实时预览</div>
          <div class="content-comment-main-left-btn">
            <img src="/static/images/home/comment_btn_icon.png">
          </div>
        </div>
        <div class="content-comment-main-right">
          <div class="content-comment-main-right-img">
            <img src="/static/images/home/comment_right_img.png">
          </div>
        </div>
      </div>
    </div>
    <div class="content-alertB" v-if="pageData.mayAlertList[0]">
      <div class="content-X-title">
        火情报警
      </div>
      <div class="content-alertB-main">
        <div class="content-alertB-main-item" v-for="(item, index) in pageData.mayAlertList" v-if="index%2 === 0" @click="handleAlertItemClick(item.whole)">
          <div class="content-alertB-main-item-left">
            <div class="content-alertB-main-item-title">{{item.title}}</div>
            <div class="content-alertB-main-item-address">{{item.address}}</div>
            <div class="content-alertB-main-item-status" :style="{ color: pageConfig.statusEnum[item.status].color }">{{pageConfig.statusEnum[item.status].label}}</div>
            <div class="content-alertB-main-item-date">{{item.date}}</div>
          </div>
          <div class="content-alertB-main-item-right" v-if="pageData.mayAlertList[index + 1]">
            <div class="content-alertB-main-item-title">{{pageData.mayAlertList[index + 1].title}}</div>
            <div class="content-alertB-main-item-address">{{pageData.mayAlertList[index + 1].address}}</div>
            <div class="content-alertB-main-item-status" :style="{ color: pageConfig.statusEnum[pageData.mayAlertList[index + 1].status].color }">{{pageConfig.statusEnum[pageData.mayAlertList[index + 1].status].label}}</div>
            <div class="content-alertB-main-item-date">{{pageData.mayAlertList[index + 1].date}}</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="content-device">
      ...
      <div class="content-device-main" @click="handleDeviceClick">
        <div class="content-device-main-left">
          <div class="content-device-main-left-title">设备档案</div>
          <div class="content-device-main-left-mark">更多设备信息</div>
        </div>
        <div class="content-device-main-right">
          <img src="/static/images/home/device_right_img.png">
        </div>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      async handleFlashPage () {
        ...
        this.pageData.mayAlertList = (await this.$request('/AppFire/selectByCriteria', 'POST', {
