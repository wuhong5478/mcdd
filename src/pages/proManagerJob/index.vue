  ...
  export default {
    ...
    data () {
      return {
        pageConfig: {
          ...
          navList: [{
            title: '超时任务',
            icon: '/static/images/work/clock_gray_icon.png',
            ...
            title: '视频监控',
            icon: '/static/images/work/jiankong_gray_icon.png',
            url: '../controlRoom/main',
            style: {
              height: '40rpx',
              width: '30rpx'
            }
    ...
    methods: {
      ...
      async handleFlashPage () {
        ...
        let alertNum = (await this.$request('/appStatistics/countFireWarn', 'POST', {
