<template>
  <div class="content">
    ...
    <div class="content-list">
      <div class="content-list-item" v-for="(item, index) in pageData.checkList" :key="index" @click="handleItemClick(item)">
  ...
  export default {
    ...
    watch: {
      pageStatus: {
        handler: async function pageStatusHandler () {
          ...
          this.pageData.checkList = (await this.$request('/PatrolInspection/selectByTrountId', 'POST', {
            trountId: this.pageData.currentId,
    ...
    methods: {
      ...
      handleItemClick (item) {
        mpvue.navigateTo({
          url: `../homeCheckObjectDetail/main?item=${JSON.stringify(item.whole)}`
        })
      }
    }
  }
